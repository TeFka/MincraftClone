...
Shader::Shader(const char* vertexF, const char* fragmentF, const char* geometryF, int useGeom)
{
...
void Shader::set1i(const GLint &value, const GLchar* name)
{
    this->use();
    glUniform1i(glGetUniformLocation(this->id,name), value);
    this->unUse();
}
void Shader::set1f(const GLfloat &value, const GLchar* name)
{
    this->use();
    glUniform1f(glGetUniformLocation(this->id,name),value);
    this->unUse();
}
void Shader::setVec2f(const glm::fvec2 &value, const GLchar* name)
{
    this->use();
    glUniform2fv(glGetUniformLocation(this->id,name),1,glm::value_ptr(value));
    this->unUse();
}
void Shader::setVec3f(const glm::fvec3 &value, const GLchar* name)
{
    this->use();
    glUniform3fv(glGetUniformLocation(this->id,name),1,glm::value_ptr(value));
    this->unUse();
}
void Shader::setVec4f(const glm::fvec4 &value, const GLchar* name)
{
    this->use();
    glUniform4fv(glGetUniformLocation(this->id,name),1,glm::value_ptr(value));
    this->unUse();
}
void Shader::setMat3(const glm::mat3 &value, const GLchar* name, GLboolean trans)
{
    this->use();
    glUniformMatrix3fv(glGetUniformLocation(this->id,name),1,trans,glm::value_ptr(value));
    this->unUse();
}
void Shader::setMat4(const glm::mat4 &value, const GLchar* name, GLboolean trans)
{
this->use();
